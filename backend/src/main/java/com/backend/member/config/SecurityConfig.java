...
import com.backend.member.security.jwt.exception.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .mvcMatchers("/api/members/signup", "/api/policy/**").permitAll()
            .mvcMatchers( "/api/members/login", "/api/members/refreshToken").permitAll()
